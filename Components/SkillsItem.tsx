  ...
  return (
    <div className='mb-[4rem] md:mb-[8rem] '>
        ...
        <p className='text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80'>
          Mastering multiple technologies and ability to integrate, passion for web development. 
          Adept at building feature-rich applications, keen eye for performance optimization, security, and best practices.
        </p>
    </div>
  )
}
